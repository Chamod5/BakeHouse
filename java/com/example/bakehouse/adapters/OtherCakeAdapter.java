...
public class OtherCakeAdapter extends RecyclerView.Adapter<OtherCakeAdapter.CakeViewHolder> {

    private Context context;
    private List<OthersCakeModel> cakeList;

    public OtherCakeAdapter(Context context, List<OthersCakeModel> cakeList) {
    ...
    public void onBindViewHolder(@NonNull CakeViewHolder holder, int position) {
        OthersCakeModel cake = cakeList.get(position);
